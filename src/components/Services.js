...
import {Container,Row,Col,Image,Card,Nav,form,Button,Modal,Form} from 'react-bootstrap';
import './service.css';
...
<input style={{width:'400px'}} type="search" class="form-control rounded" placeholder="Search" aria-label="Search"
    ...
    <br></br>  <button type="button"  style={{width:'400px',height:'40px',backgroundColor:'rgb(199, 80, 80)',  border: 'none'
}}>search</button>
