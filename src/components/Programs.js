...
class Programs extends React.Component {
    ...
    dataHandle = () => {
        ...
        let newDataArray = ArrOFCard.filter((item) => {
            if (item.header === 'Weight Loss Programs') {
                return item;

            }
            else if (item.header === 'Weight Stability Programs') {
                return item;
            }
            else if (item.header === 'Foods to gain weight') {
                return item;
            }
            return newDataArray
        });
            ...
            <body>
                ...
                <>
                    ...
                    <FloatingLabel controlId="floatingSelect" label="Select your Program">
                        <Form.Select id='SelectPrograms' aria-label="Floating label select example" onChange={this.dataHandle} >
                            ...
                            <option value="1">Weight Loss Programs</option>
                            <option value="2">Weight Stability Programs</option>
                            <option value="3">Weight Gain Programs</option>
                        </Form.Select>
                    </FloatingLabel>
                    ...
                    <div style={{ padding: '40px' }}>
                        ...
                        <Col >
                            <Row xs={6} md={3}>
                                ...
                                <Card id='Weight Loss Programs' border="info" style={{ width: '18rem' }}>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            ** The Mediterranean diet:
                                            <br />
                                            is inspired by the eating patterns of countries like Italy, Spain, and Greece.
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            ...
                                            ** Carb-restricted diet:
                                            <br />
                                            Carb-restricted diets are often recommended to help support blood sugar control and increase weight loss among those with type 2 diabetes (14Trusted Source).
                ...
                <>
                    ...
                    <section style={{ padding: '40px' }}>
                        ...
                        <Col >
                            <Row xs={6} md={3}>
                                <Card id='Weight Stability Programs' border="secondary" style={{ width: '18rem' }}>
                                    <Card.Header>
                    ...
                    <div style={{ padding: '40px' }}>
                        ...
                        <Col >
                            <Row xs={6} md={3}>
                                ...
                                <Card id='Foods to gain weight' border="danger" style={{ width: '18rem' }}>
